...
<nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(to right, #2c3e50, #3498db) !important;">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link fw-normal" aria-current="page" href="doctor.jsp" style="color: rgba(255, 255, 255, 0.8); text-decoration: none;">
                        <i class="fa fa-user-md me-1" aria-hidden="true"></i>DOCTOR
                    </a>
                </li>
                  <li class="nav-item">
                    <a class="nav-link fw-normal" aria-current="page" href="view_doctor.jsp" style="color: rgba(255, 255, 255, 0.8); text-decoration: none;">
                        <i class="fa fa-sign-in me-1" aria-hidden="true"></i>VIEW DOCTOR
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-normal" aria-current="page" href="patient.jsp" style="color: rgba(255, 255, 255, 0.8); text-decoration: none;">
                        <i class="fa fa-calendar me-1" aria-hidden="true"></i>PATIENT
                    </a>
                </li>
            </ul>
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="left: auto; right: 0;">
        <li><a class="dropdown-item text-white" href="../adminLogout" style="color: white; background-color: #2980b9;">Logout</a></li>
    </ul>
</div>
